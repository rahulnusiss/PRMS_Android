...
def get_tasks3():
    #json_data = jsonify(request.json)
    print(request.json) 
    json_response = """{ "psList": [ {"id": 123, "dateofProgram": "2011-07-14", "duration": "02:00:00", "programName": "test", "startTime": "03:00:00+08:00", "presenter":"present1","producer":"produce1" } , {"id":234, "dateofProgram": "2013-08-16", "duration": "04:00:00", "programName": "test3", "startTime": "03:00:00+08:00" ,"presenter":"present2","producer":"produce2"}] }"""
    return Response(json_response, mimetype='application/json')
...
@app.route('/phoenix/rest/radioprogram/all',methods=['GET'])
def get_tasks8():
    #json_data = jsonify(request.json)
    print(request.json) 
    json_response = """{ "rpList": [ {"name": "test", "description": "TestRPDescription", "typicalDuration": "03:00:00"} ,{"name": "test2", "description": "Test2RPDescription","typicalDuration": "04:00:00"} ]}"""
    return Response(json_response, mimetype='application/json')
...
if __name__ == '__main__':
    ...
    #{ "psList": [ {"id": 123, "dateofProgram": "2011-07-14", "duration": "02:00:00", "programName": "test", "startTime": "03:00:00+08:00", "presenter":"present1","producer":"produce1" } , { "id":234,"dateofProgram": "2013-08-15", "duration": "01:00:00", "programName": "test2", "startTime": "03:00:00+08:00" }, { "dateofProgram": "2013-08-16", "duration": "04:00:00", "programName": "test3", "startTime": "03:00:00+08:00" ,"presenter":"present2","producer":"produce2"}] }
    #"""{ "rpList": [ {name": "test", "description": "TestRPDescription", "programName": "test", "typicalDuration": "03:00:00"} , {"id":234, "dateofProgram": "2013-08-16", "duration": "04:00:00", "programName": "test3", "startTime": "03:00:00+08:00" ,"presenter":"present2","producer":"produce2"}] }"""
